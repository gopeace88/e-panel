...
export const getStatistics = () => {
  ...
  return {
    ...
    byBuilding: {
      '본관': allPanels.filter(p => p.building === '본관').length,
      '2공장': allPanels.filter(p => p.building === '2공장').length,
      '3공장': allPanels.filter(p => p.building === '3공장').length
    }
  }
}
